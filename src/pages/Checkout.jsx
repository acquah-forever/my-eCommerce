...
const Checkout = () => {
  ...
  return (
    <div className='p-4 sm:p-6 lg:p-7 max-w-6xl mx-auto'>

      <div className='mb-6 sm:mb-10 px-2 sm:px-3'><h1 className='text-2xl sm:text-3xl font-semibold'>Checkout</h1></div>
