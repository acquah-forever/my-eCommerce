    ...
    <div className='flex flex-col relative bg-[url("https://cdn.pixabay.com/photo/2024/01/29/14/40/warehouse-8540045_1280.jpg")] bg-cover bg-center bg-fixed bg-no-repeat'>
      ...
      <div className='relative z-50 py-20'>
        <div className='flex flex-col justify-center items-center space-y-5 text-white'>
          ...
          <p className='text-xl'>Discover Amaxing Products at Great Prices</p>
        </div>
        <div className='p-5 mb-5'>
          <h2 className='font-semibold text-2xl text-white'>Our Products</h2>
        </div>
        <div className='grid space-x-7 space-y-5 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 px-10'>
